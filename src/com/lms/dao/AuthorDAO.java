...
public class AuthorDAO extends BaseDAO{
	...
	public List<Author> readAuthorsByBook(String name, int pageNo) throws ClassNotFoundException, SQLException{
		setPageNo(pageNo);
		name = "%"+name+"%";
		return (List<Author>) readAll("select * from tbl_author as a left join tbl_book_authors as ba on ba.authorId=a.authorId left join tbl_book as b on ba.bookId=b.bookId where b.title like ?", new Object[] {name});
	}
